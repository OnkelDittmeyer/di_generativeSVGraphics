...
//methods
			this.updateViz = function(data) {
				...
				//console.log('update 0_2');

//star update
				path = 'M'+
						(vizWidth/2 - parseInt(social[0][0])*fa) +' '+
						(vizHeight/2 - parseInt(social[0][1]*fa)) +' l'+
						(5+fa* parseInt(social[1][0])) +' '+
						(2+fa* parseInt(social[1][1])) +' l'+
						(5+fa* parseInt(social[2][0])) +' '+
						(2+fa* parseInt(social[2][1])) +' l'+						
						(3+fa* parseInt(social[3][0])) +' '+
						(2+fa* parseInt(social[3][1])) +' l'+						
						(6+fa* parseInt(social[4][0])) +' '+
